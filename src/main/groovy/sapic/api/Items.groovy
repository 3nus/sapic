...
// Sample call:
//      $ curl "http://sandbox.iii.com:80/iii/sierra-api/v0.5/items?apiKey=<value>"
...
class Items extends APIBase {

    // ---------------------------
    // requests /iii/sierra-api/v0.5/items and returns a sapic.resource.Items object
